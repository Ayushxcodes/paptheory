              ...
              <form className="space-y-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      id="firstName"
                      name="firstName"
                      className="w-full px-5 py-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ff5a1f] focus:border-transparent text-base"
                      placeholder="John"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={8}
                    className="w-full px-5 py-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ff5a1f] focus:border-transparent text-base resize-vertical"
                    placeholder="Tell us about your project..."
                  />
                </div>
                <Button className="w-full bg-[#ff5a1f] hover:bg-[#e54d1f] text-white py-4 px-6 rounded-lg font-medium transition-colors text-lg">
                  Send Message
                </Button>
              </form>
            </div>
            ...
            <div className="space-y-8 lg:pt-10">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-[#ff5a1f] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">hello@papertheory.com</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-[#ff5a1f] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a href="#" className="w-10 h-10 bg-[#ff5a1f] rounded-full flex items-center justify-center hover:bg-[#e54d1f] transition-colors">
