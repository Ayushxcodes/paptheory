    ...
    <div className="w-full">
      <div className="w-full flex bg-[#f99216] text-white">
        <Link href="/?filter=IT#work" onClick={handleEngineeringClick} className="w-1/2">
          <div className="py-1 px-6 flex items-center justify-center gap-3 hover:bg-[#e54a1a] transition-colors cursor-pointer">
        ...
        <a href="/works" target="_blank" rel="noopener noreferrer" className="w-1/2">
          <div className="py-1 px-6 flex items-center justify-center gap-3 hover:bg-[#e54a1a] transition-colors cursor-pointer border-l border-white/20">
