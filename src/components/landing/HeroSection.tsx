...
export default function HeroSection() {
  return (
    <section className="w-full bg-neutral-100 h-screen">
      <div className="mx-auto max-w-7xl px-6 h-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-start pt-30">
        {/* Left content */}
        <div className="space-y-8">
            <h2 className="text-5xl lg:text-6xl font-semibold tracking-tight text-neutral-900">
            PAPER THEORY NETWORK
          </h2>
          <h2 className="text-5xl lg:text-4xl tracking-tight text-neutral-900">
